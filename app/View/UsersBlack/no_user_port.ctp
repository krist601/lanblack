                    ...
                    <div class="col-sm-8" style="background: white; border: 1px solid rgba(230, 230, 230, 0.7); padding: 0px;">
                        ...
                        <div style="padding-left: 35px;padding-right: 35px;">
                                <div class="vd_panel-header">
                                    <h1>O usuário especificado não existe no sistema</h1>
                                </div>
                                <div style="padding-top: 0px; padding-left: 30px;">
                            Este site é apenas para membros PRETO Malta. Verifique suas informações de contato e qualquer dúvida entre em contato com o Contact Center Seleccionados.
                                </div>
								<br>
								<br>
