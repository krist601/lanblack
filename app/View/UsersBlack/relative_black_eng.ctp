              ...
              <div id="content">
                  ...
                  <div class="col-sm-2"></div>
                    <div class="col-sm-8" style="background: white; border: 1px solid rgba(230, 230, 230, 0.7); padding: 0px;">
                        ...
                        <a href="<?php echo $this->Html->url(array('controller' => 'relatives', 'action' => 'addFromUser', $idBlack)) ?>" class="btn btn-info start" style="margin: 10px;margin-left: 70px;"> <i class="glyphicon glyphicon-plus"></i> <span> Add relative</span> </a>
                        <a href="<?php echo $this->Html->url(array('controller' => 'UsersBlack', 'action' => 'finishEng')) ?>" class="btn btn-info start"> <i class="glyphicon glyphicon-upload"></i> <span> Finish</span> </a>
                    </div>
                    <div class="col-sm-2"></div>
              </div>
