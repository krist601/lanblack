              ...
              <div id="content">
                  ...
                  <div class="col-sm-2"></div>
                    <div class="col-sm-8" style="background: white; border: 1px solid rgba(230, 230, 230, 0.7); padding: 0px;">
                        ...
                        <a href="<?php echo $this->Html->url(array('controller' => 'UsersBlack', 'action' => 'addBlackSpa',$idBlack, $token)) ?>" class="btn btn-info start"> <i class="glyphicon glyphicon-upload"></i> <span> Edit principal user</span> </a>
