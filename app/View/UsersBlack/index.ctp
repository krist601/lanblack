                                ...
                                <?php foreach ($usersBlack as $userBlack): ?>
                                    <tr>
                                        ...
                                        <td class="userBlack-action" style="padding: 16px;text-align: center;">
                                            <div style=" width: 170px;"> <a data-original-title="Ver" data-toggle="tooltip" data-placement="top" class="btn userBlack-icon vd_bd-yellow vd_yellow" href="<?php echo $this->Html->url(array('action' => 'view', $userBlack['UserBlack']['idUserBlack'])); ?>"> <i class="fa fa-eye"></i> </a>
