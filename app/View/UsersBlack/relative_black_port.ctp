              ...
              <div id="content">
                  ...
                  <div class="col-sm-2"></div>
                    <div class="col-sm-8" style="background: white; border: 1px solid rgba(230, 230, 230, 0.7); padding: 0px;">
                            ...
                            <table class="table table-hover demo-table-search">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;">Tipo Família</th>
                        ...
                        <a href="<?php echo $this->Html->url(array('controller' => 'UsersBlack', 'action' => 'addBlackSpa',$idBlack, $token)) ?>" class="btn btn-info start"> <i class="glyphicon glyphicon-upload"></i> <span> Edite usuário principal</span> </a>
