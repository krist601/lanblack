                        ...
                        <div style="padding-left: 35px;padding-right: 35px;">
                           ...
                           <br>
                                ...
                                <?php if($relativeType==0){ ?>
		                           <div class="form-group form-group-default" aria-required="true">
		                                <?php echo $this->Form->input('relativeType', array('label' => 'Tipo de Familiar', 'class' => 'form-control',
		                                    'options' => array('Hijo/a'=>'Filho/a','Esposo/a' => 'Esposo/a', 'Cónyuge' => 'Cônjuge', 'Padre' => 'Pai', 'Madre' => 'Mãe')
		                                ));?>
		                            </div>
                                <?php } ?>
                                <?php if($relativeType==1){ ?>
		                           <div class="form-group form-group-default" aria-required="true">
		                                <?php echo $this->Form->input('relativeType', array('label' => 'Tipo de Familiar', 'class' => 'form-control',
		                                    'options' => array('Padre' => 'Pai', 'Madre' => 'Mãe')
		                                ));?>
		                            </div>
                                <?php } ?>
                                <?php if($relativeType==2){ ?>
		                           <div class="form-group form-group-default" aria-required="true">
		                                <?php echo $this->Form->input('relativeType', array('label' => 'Tipo de Familiar', 'class' => 'form-control',
		                                    'options' => array('Hijo/a'=>'Filho/a','Esposo/a' => 'Esposo/a', 'Cónyuge' => 'Cônjuge')
		                                ));?>
		                            </div>
                                <?php } ?>
                            <div class="form-group form-group-default" aria-required="true">
                            ...
                            <div class="form-group form-group-default" aria-required="true">
                                <?php echo $this->Form->input('observation', array('label' => 'Observações','type'=>'textarea','style'=>' height: 70%;', 'class' => 'form-control'));?>
                            </div>-->
