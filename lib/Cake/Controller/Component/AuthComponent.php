 ...
 */
	protected function _setDefaults() {
		$defaults = array(
			...
			'authError' => __d('cake', '<div class="alert alert-danger"> <span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span>No tienes acceso a esta locación </div>')
		);
